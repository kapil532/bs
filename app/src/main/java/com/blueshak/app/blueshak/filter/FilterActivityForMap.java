...
public class FilterActivityForMap extends RootActivity implements OnSelected, LocationListener {
    ...
    public static Intent newInstance(Context context, LocationModel locationModel, int from) {
        ...
        Intent mIntent = new Intent(context, FilterActivityForMap.class);
  ...
  /*  sorting=(Switch)findViewById(R.id.sorting);*/
    ...
    public void resetValues() {
        ...
        GlobalFunctions.removeSharedPreferenceKey(context, GlobalVariables.FILTER_MODEL_FOR_MAP);
        is_all = true;
