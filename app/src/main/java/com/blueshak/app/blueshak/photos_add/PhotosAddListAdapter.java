        ...
        try {
            if (position < 5) {
                if (convertView == null) {
                    ...
                    viewHolder.tvAddNewPic = (TextView) view.findViewById(R.id.tv_add_new_pic);
                ...
                if(list.size() == 1){
                    holder.tvAddNewPic.setVisibility(View.VISIBLE);
                }else{
                    holder.tvAddNewPic.setVisibility(View.GONE);
                }
