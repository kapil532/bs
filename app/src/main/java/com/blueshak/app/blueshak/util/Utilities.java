...
import com.blueshak.app.blueshak.text.ExpandedSpannable;
import com.blueshak.blueshak.R;
import com.nostra13.universalimageloader.core.DisplayImageOptions;
import com.nostra13.universalimageloader.core.ImageLoader;

/**
 * Created by lsingh013 on 30/05/18.
 */

public class Utilities {

    public static void setBitmapImages(ImageView imageView, String decodedImgUri) {
    ...
    private static void setBitmapDecodedImage(ImageView imageView, DisplayImageOptions GALLERY, String decodedImgUri) {
    ...
    private static SpannableStringBuilder addClickablePartTextViewResizable(final Spanned strSpanned, final TextView tv,
        ...
        if (str.contains(spanableText)) {
            ...
            ssb.setSpan(new ExpandedSpannable(false){
                @Override
